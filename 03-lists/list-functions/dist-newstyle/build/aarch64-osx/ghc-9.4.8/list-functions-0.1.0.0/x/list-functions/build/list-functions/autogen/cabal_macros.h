...
/* package list-functions-0.1.0.0 */
#ifndef VERSION_list_functions
#define VERSION_list_functions "0.1.0.0"
#endif /* VERSION_list_functions */
#ifndef MIN_VERSION_list_functions
#define MIN_VERSION_list_functions(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_list_functions */
...
#define CURRENT_COMPONENT_ID "list-functions-0.1.0.0-inplace-list-functions"
